...
public:
    ...
    // Match a given scan against only specific candidate indices (GPS-filtered)
    std::pair<int, float> detectBestMatchAmongCandidates(
...
public:
    ...
    // last match distance (for diagnostics)
    double last_match_dist = -1.0;
